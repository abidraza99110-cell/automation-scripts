...
def fetch_jobs():
    ...
    try:
        ...
        for job in data[1:15]:
            ...
            print(f"Processing: {company} - {position}")
...
def filter_niche(leads_list):
    ...
    for lead in leads_list:
        print(f"Processing: {lead['Company']} - {lead['Role']}")
...
def generate_email(company, role, tier):
    ...
    if tier == "Decision Maker":
        return f"""Subject: Helping {company} hire faster\n\nHi {company} Team,\n\nI noticed you're hiring for {role}. I’ve built automation tools that help teams reduce manual work and speed up hiring workflows.\n\nThis could help your team save time on repetitive tasks.\n\nWould you be open to a quick chat?\n\nBest regards,\n[Your Name]\n"""
    else:
